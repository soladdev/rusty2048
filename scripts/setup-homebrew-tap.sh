...
class Rusty2048Cli < Formula
  ...
  homepage "https://github.com/soladdev/rusty2048"
  version "${version}"
  
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/soladdev/rusty2048/releases/download/v${version}/rusty2048-cli-macos-aarch64.tar.gz"
      sha256 "${sha256}"
    else
      url "https://github.com/soladdev/rusty2048/releases/download/v${version}/rusty2048-cli-macos-x86_64.tar.gz"
      sha256 "${sha256}"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/soladdev/rusty2048/releases/download/v${version}/rusty2048-cli-linux-aarch64.tar.gz"
      sha256 "${sha256}"
    else
      url "https://github.com/soladdev/rusty2048/releases/download/v${version}/rusty2048-cli-linux-x86_64.tar.gz"
      sha256 "${sha256}"
    end
  end
...
main() {
    ...
    local download_url="https://github.com/soladdev/rusty2048/releases/download/v${version}/rusty2048-cli-${os}-${arch}.tar.gz"
    ...
    echo "   brew install soladdev/tap/rusty2048-cli"
